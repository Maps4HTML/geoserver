...
public class MapMLFormatOptionsMatrixTest extends MapMLTestSupport {
    ...
    public void testScenarioH2_1_RasterWithImageCacheMapMLResponseMapTileSrcIsGetTile() throws Exception {
        // Enable tile caching using the MockData.WORLD constant
        enableTileCaching(WORLD, getCatalog());
        ...
        try {
            ...
            disableTileCaching(WORLD, getCatalog());
        }
    }
    ...
    public void testScenarioH2_2_RasterWithNoImageCacheMapMLResponseMapTileSrcIsGetMap() throws Exception {
        ...
        enableTileCachingMapMLOnly(WORLD, getCatalog());
