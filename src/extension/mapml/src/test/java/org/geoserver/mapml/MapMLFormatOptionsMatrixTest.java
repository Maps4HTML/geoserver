...
public class MapMLFormatOptionsMatrixTest extends MapMLTestSupport {
    ...
    public void testScenarioC1_NoTileCache() throws Exception {
        ...
        // Should have tile-related link (tile-shaped GetMap)
        assertTrue(
                "Should have tile-related link when mapmlusetiles=true",
                xpath.evaluate("//html:map-link[@rel='tile']", doc) != null
                        || xpath.evaluate("//html:map-link[@rel='image']", doc) != null);
    ...
    /**
     * Test Scenario F.1: mapmlusefeatures=true, mapmlusemultiextents=true, mapmlusetiles=false 
     * Expected: Multiple map-extents, raster layers as rel=features tref="...request=GetMap..."
     */
    @Test
    ...
    public void testScenarioG2_WithTileCache() throws Exception {
        ...
        try {
            ...
            String tileUrl = xpath.evaluate("//html:map-link[@rel='tile']/@tref", doc);
            assertTrue(
                    "Should use GetTile when tile cache available",
     ...
     * map-extents with tile-shaped requests + features (vector no cache)
     */
    @Test
    public void testScenarioH3_VectorNoCache() throws Exception {
     ...
     */
    @Test
    public void testScenarioH4_VectorWithCache() throws Exception {
        enableTileCaching(new QName(MockData.CITE_URI, MIXED_GROUP_CACHED), getCatalog());
        ...
        try {
            ...
            assertTrue(
                    "Should use GetTile when tile cache available",
                    tileUrl.contains("GetTile") || tileUrl.contains("gwc"));
